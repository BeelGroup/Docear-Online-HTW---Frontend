require ['logger', 'views/templates.pre.min', 'NodeFactory','feedbackForm', 'views/MapView','routers/DocearRouter', 'views/RootNodeView', 'views/CanvasView', 'views/MinimapView', 'views/ZoomPanelView', 'models/mindmap/RootNode', 'config', 'features', 'ribbons', 'collections/workspace/Workspace', 'collections/workspace/Files', 'models/workspace/Project', 'models/workspace/File', 'views/workspace/WorkspaceView'],  (logger, templates, NodeFactory, FeedbackForm, MapView, DocearRouter, RootNodeView, CanvasView, MinimapView, ZoomPanelView, RootNodeModel, config, features, ribbons, Workspace, Files, Project, File, WorkspaceView) -> 
